...
namespace DAL
{
    public class DALProduto
    {
        ...
        public void Incluir(ModeloProduto obj)
        {
            ...
            "values (@nome,@descricao,@foto,@valorpago,@valorvenda,@qtde , 1,@catcod);    select @@IDENTITY;";
        ...
        public void Alterar(ModeloProduto obj)
        {
            ...
            cmd.CommandText = "UPDATE Produto SET pro_nome = (@nome), pro_descricao = (@descricao), "+
                "pro_foto = (@foto), pro_valorpago = (@valorpago), "+
        ...
        public DataTable Localizar(String valor)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("Select p.pro_cod, p.pro_nome, p.pro_descricao as descricao, p.pro_foto as foto,"+
                "p.cat_cod, p.scat_cod, u.umed_nome, c.cat_nome as raca " +
 "from Produto p inner join undmedida u on p.umed_cod = u.umed_cod inner join categoria c on p.cat_cod = c.cat_cod  inner join subcategoria sc on p.scat_cod = sc.scat_cod "+
